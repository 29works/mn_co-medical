		...
		return (
			...
			this.each(function () {
				...
				'background' === v
					...
					: 'foreground' === v && ('vertical' === w ? e.vertical(k, z, u, t) : 'horizontal' === w && e.horizontal(k, z, u, t)),
					a(window).on('resize', function () {
						...
						c || (window.requestAnimationFrame(d), (c = !0)),
							'background' === v
								? (g.background(k), 'vertical' === w ? e.bgVertical(k, y) : 'horizontal' === w && e.bgHorizontal(k, y))
								: 'foreground' === v && o <= j && (g.foreground(k), 'vertical' === w ? e.vertical(k, q, u) : 'horizontal' === w && e.horizontal(k, q, u));
					}),
						...
						c || (window.requestAnimationFrame(d), (c = !0)),
							'background' === v
								? 'vertical' === w
									? e.bgVertical(k, y)
									: 'horizontal' === w && e.bgHorizontal(k, y)
								: 'foreground' === v && g <= j && ('vertical' === w ? e.vertical(k, q, u, t) : 'horizontal' === w && e.horizontal(k, q, u, t));
					});
			})
		);
	};
