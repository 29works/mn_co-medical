				...
				var i = e(38),
					...
					f = function () {
						var t,
							n = e(59)('iframe'),
							r = u.length;
						for (n.style.display = 'none', e(73).appendChild(n), n.src = 'javascript:', (t = n.contentWindow.document).open(), t.write('<script>document.F=Object</script>'), t.close(), f = t.F; r--; )
							delete f[a][u[r]];
						return f();
					};
				t.exports =
				...
				(t(52).inspectSource = function (t) {
					...
					(n.exports = function (t, n, r, e) {
						...
						i && (c(r, 'name') || u(r, 'name', n)),
							t[n] !== r && (i && (c(r, a) || u(r, a, t[n] ? '' + t[n] : f.join(String(n)))), t === o ? (t[n] = r) : e ? (t[n] ? (t[n] = r) : u(t, n, r)) : (delete t[n], u(t, n, r)));
			...
			function (t, n, r) {
				var e = (function (o) {
					...
					function maybeInvokeDelegate(t, n) {
						...
						return i
							? i.done
								? ((n[t.resultName] = i.value), (n.next = t.nextLoc), 'return' !== n.method && ((n.method = 'next'), (n.arg = c)), (n.delegate = null), p)
								: i
					...
					return (
						...
						(o.mark = function (t) {
							return (
								Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : ((t.__proto__ = GeneratorFunctionPrototype), e in t || (t[e] = 'GeneratorFunction')),
