...
var ScrollReveal = (function () {
	...
	function m(e) {
		...
		if (E.generated || A.generated.initial) {
			...
			var P = i.delay,
				L = i.duration,
				M = i.easing;
			E.generated && q.fragments.push({ delayed: 'opacity ' + L / 1e3 + 's ' + M + ' ' + P / 1e3 + 's', instant: 'opacity ' + L / 1e3 + 's ' + M + ' 0s' }),
				A.generated.initial && q.fragments.push({ delayed: A.property + ' ' + L / 1e3 + 's ' + M + ' ' + P / 1e3 + 's', instant: A.property + ' ' + L / 1e3 + 's ' + M + ' 0s' }),
				q.computed && !q.computed.match(/all 0s|none 0s/) && q.fragments.unshift({ delayed: q.computed, instant: q.computed });
	...
	function i(e, a, t) {
		...
		f(d, function (e) {
			...
			!0 !== t && (this.store.history.push({ target: e, options: a }), this.initTimeout && window.clearTimeout(this.initTimeout), (this.initTimeout = window.setTimeout(b.bind(this), 0)));
	}
	var j,
		T =
			Math.sign ||
	...
	function $(e) {
		...
		return (!(I = t).mobile && w()) || (!I.desktop && !w())
			? (h.call(this, 'This device is disabled.', 'desktop: ' + I.desktop, 'mobile: ' + I.mobile), n.failure())
			: (n.success(),
