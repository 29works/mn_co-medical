...
$(function() {
    var swipervoice = new Swiper('#user_voice .swiper-container', {
        loop: true,
        slidesPerView: 3,
        spaceBetween: 10,
        centeredSlides: true,
...
$(function() {
    ...
    // TOP
    ScrollReveal().reveal('.main-hanabi', {
        distance: '50px',
        origin: 'bottom',
        duration: '2000',
        delay: '1000'
    ...
    // TOP btn
    ScrollReveal().reveal('.cta_area .btn_entry', {
        distance: '50px',
        origin: 'bottom',
        duration: '1000'
    });
    // middle btn
    ScrollReveal().reveal('.main-img .btn_entry', {
        distance: '50px',
        origin: 'bottom',
        viewFactor: '0.8',
        duration: '1000',
