	...
	var a,
		t = function (e, i) {
			...
			function d() {
				...
				return (
					!a && document.implementation && document.implementation.hasFeature && document.implementation.hasFeature('', '') !== !0 && (a = document.implementation.hasFeature('Events.wheel', '3.0')), a
				);
			}
			function u(e) {
				e.originalEvent && (e = e.originalEvent);
				...
				(b.container[0].swiper = b),
					...
					b.params.pagination &&
						...
						'bullets' === b.params.paginationType && b.params.paginationClickable
							? b.paginationContainer.addClass(b.params.paginationModifierClass + 'clickable')
						...
						if ('undefined' != typeof b.size) {
							...
							for (e = 0; e < b.slides.length; e++) {
								...
								'none' !== u.css('display') &&
									('auto' === b.params.slidesPerView
										? ((o = b.isHorizontal() ? u.outerWidth(!0) : u.outerHeight(!0)), b.params.roundLengths && (o = r(o)))
									...
									b.params.centeredSlides
										? ((t = t + o / 2 + s / 2 + a), 0 === e && (t = t - b.size / 2 - a), Math.abs(t) < 0.001 && (t = 0), i % b.params.slidesPerGroup === 0 && b.snapGrid.push(t), b.slidesGrid.push(t))
							...
							0 === b.snapGrid.length && (b.snapGrid = [0]),
								0 !== b.params.spaceBetween &&
									(b.isHorizontal() ? (b.rtl ? b.slides.css({ marginLeft: a + 'px' }) : b.slides.css({ marginRight: a + 'px' })) : b.slides.css({ marginBottom: a + 'px' })),
					...
					(b.updateClasses = function () {
						...
						e.addClass(b.params.slideActiveClass),
							i.loop &&
								(e.hasClass(b.params.slideDuplicateClass)
									? b.wrapper
											.children('.' + b.params.slideClass + ':not(.' + b.params.slideDuplicateClass + ')[data-swiper-slide-index="' + b.realIndex + '"]')
											.addClass(b.params.slideDuplicateActiveClass)
									: b.wrapper
											.children('.' + b.params.slideClass + '.' + b.params.slideDuplicateClass + '[data-swiper-slide-index="' + b.realIndex + '"]')
											.addClass(b.params.slideDuplicateActiveClass));
						...
						if (
							(b.params.loop && 0 === s.length && ((s = b.slides.eq(-1)), s.addClass(b.params.slidePrevClass)),
							i.loop &&
								(t.hasClass(b.params.slideDuplicateClass)
									...
									: b.wrapper
											.children('.' + b.params.slideClass + '.' + b.params.slideDuplicateClass + '[data-swiper-slide-index="' + t.attr('data-swiper-slide-index') + '"]')
											.addClass(b.params.slideDuplicateNextClass),
								s.hasClass(b.params.slideDuplicateClass)
									? b.wrapper
											.children('.' + b.params.slideClass + ':not(.' + b.params.slideDuplicateClass + ')[data-swiper-slide-index="' + s.attr('data-swiper-slide-index') + '"]')
											.addClass(b.params.slideDuplicatePrevClass)
									: b.wrapper
											.children('.' + b.params.slideClass + '.' + b.params.slideDuplicateClass + '[data-swiper-slide-index="' + s.attr('data-swiper-slide-index') + '"]')
											.addClass(b.params.slideDuplicatePrevClass)),
							...
							if (
								(b.params.loop
									? ((r = Math.ceil((b.activeIndex - b.loopedSlides) / b.params.slidesPerGroup)),
									  ...
									  r > n - 1 && (r -= n),
									  r < 0 && 'bullets' !== b.params.paginationType && (r = n + r))
								...
								'fraction' === b.params.paginationType &&
									(b.paginationContainer.find('.' + b.params.paginationCurrentClass).text(r + 1), b.paginationContainer.find('.' + b.params.paginationTotalClass).text(n)),
							...
							'custom' === b.params.paginationType &&
								...
								(b.paginationContainer.html(b.params.paginationCustomRender(b, r + 1, n)), b.emit('onPaginationRendered', b, b.paginationContainer[0]));
						}
						b.params.loop ||
							(b.params.prevButton &&
								b.prevButton &&
							...
							if ((b.updateContainerSize(), b.updateSlidesSize(), b.updateProgress(), b.updatePagination(), b.updateClasses(), b.params.scrollbar && b.scrollbar && b.scrollbar.set(), e)) {
								...
								b.controller && b.controller.spline && (b.controller.spline = void 0),
									b.params.freeMode
										...
										: ((t =
												('auto' === b.params.slidesPerView || b.params.slidesPerView > 1) && b.isEnd && !b.params.centeredSlides
					...
					(b.initEvents = function (e) {
						...
						if (b.browser.ie) s[t](b.touchEvents.start, b.onTouchStart, !1), r[t](b.touchEvents.move, b.onTouchMove, n), r[t](b.touchEvents.end, b.onTouchEnd, !1);
							...
							((i.simulateTouch && !b.device.ios && !b.device.android) || (i.simulateTouch && !b.support.touch && b.device.ios)) &&
								(s[t]('mousedown', b.onTouchStart, !1), document[t]('mousemove', b.onTouchMove, n), document[t]('mouseup', b.onTouchEnd, !1));
						}
						window[t]('resize', b.onResize),
							...
							b.params.pagination &&
								...
								(b.paginationContainer[a]('click', '.' + b.params.bulletClass, b.onClickIndex),
						...
						if (((b.clickedSlide = t), (b.clickedIndex = a(t).index()), b.params.slideToClickedSlide && void 0 !== b.clickedIndex && b.clickedIndex !== b.activeIndex)) {
							...
							if (b.params.loop) {
								...
								(r = parseInt(a(b.clickedSlide).attr('data-swiper-slide-index'), 10)),
									b.params.centeredSlides
										? n < b.loopedSlides - l / 2 || n > b.slides.length - b.loopedSlides + l / 2
											? (b.fixLoop(),
											  (n = b.wrapper
													.children('.' + b.params.slideClass + '[data-swiper-slide-index="' + r + '"]:not(.' + b.params.slideDuplicateClass + ')')
													.eq(0)
													.index()),
											  setTimeout(function () {
													b.slideTo(n);
									...
									if (A || !b.browser.ieTouch) {
										...
										if (
											(s > 0 && I > b.minTranslate()
												? ((r = !1), b.params.resistance && (I = b.minTranslate() - 1 + Math.pow(-b.minTranslate() + k + s, b.params.resistanceRatio)))
												: s < 0 && I < b.maxTranslate() && ((r = !1), b.params.resistance && (I = b.maxTranslate() + 1 - Math.pow(b.maxTranslate() - k - s, b.params.resistanceRatio))),
										...
										b.params.followFinger &&
											...
											b.params.freeMode &&
												(0 === X.length && X.push({ position: b.touches[b.isHorizontal() ? 'startX' : 'startY'], time: E }),
						...
						if ((e.originalEvent && (e = e.originalEvent), M && b.emit('onTouchEnd', b, e), (M = !1), C)) {
							...
							if (
								(b.allowClick &&
									...
									s < 300 && t - G < 300 && (D && clearTimeout(D), b.emit('onDoubleTap', b, e))),
								(G = Date.now()),
								setTimeout(function () {
									b && (b.allowClick = !0);
								}, 0),
					...
					(b.onTransitionStart = function (e) {
						'undefined' == typeof e && (e = !0),
							...
							e &&
								...
								b.activeIndex !== b.previousIndex && (b.emit('onSlideChangeStart', b), b.activeIndex > b.previousIndex ? b.emit('onSlideNextStart', b) : b.emit('onSlidePrevStart', b)));
					}),
					(b.onTransitionEnd = function (e) {
						(b.animating = !1),
							...
							e &&
								...
								b.activeIndex !== b.previousIndex && (b.emit('onSlideChangeEnd', b), b.activeIndex > b.previousIndex ? b.emit('onSlideNextEnd', b) : b.emit('onSlidePrevEnd', b))),
					...
					(b.setWrapperTranslate = function (e, a, t) {
						...
						b.isHorizontal() ? (s = b.rtl ? -e : e) : (i = e),
							...
							b.params.virtualTranslate ||
								(b.support.transforms3d ? b.wrapper.transform('translate3d(' + s + 'px, ' + i + 'px, ' + n + 'px)') : b.wrapper.transform('translate(' + s + 'px, ' + i + 'px)')),
							...
							function s(a) {
								(e = a.rtl && 'horizontal' === a.params.direction ? -b.translate : b.translate),
									...
									(r && 'container' !== b.params.controlBy) ||
										((i = (a.maxTranslate() - a.minTranslate()) / (b.maxTranslate() - b.minTranslate())), (r = (e - b.minTranslate()) * i + a.minTranslate())),
							...
							if (b.params.history) {
								...
								(b.history.initialized = !0),
									...
									(this.paths.key || this.paths.value) &&
										(this.scrollToSlide(0, this.paths.value, b.params.runCallbacksOnInit), b.params.replaceState || window.addEventListener('popstate', this.setHistoryPopState));
							}
						},
					...
					(b.a11y = {
						...
						init: function () {
							b.params.nextButton &&
								b.nextButton &&
								b.nextButton.length > 0 &&
								(b.a11y.makeFocusable(b.nextButton), b.a11y.addRole(b.nextButton, 'button'), b.a11y.addLabel(b.nextButton, b.params.nextSlideMessage)),
								b.params.prevButton &&
									b.prevButton &&
									b.prevButton.length > 0 &&
									(b.a11y.makeFocusable(b.prevButton), b.a11y.addRole(b.prevButton, 'button'), b.a11y.addLabel(b.prevButton, b.params.prevSlideMessage)),
