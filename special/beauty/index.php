    ...
    <div class="contents">
      <section class="about">
        <div class="content">
          <h3 class="heading">
            <picture>
              <source media="(min-width: 768px)" srcset="../../special/img/beauty/heading_img01.svg" sizes="648px">
              <source srcset="../../special/img/beauty/heading_img01_sp.svg 450w" sizes="100%">
              <img src="../../special/img/beauty/heading_img01_sp.svg" alt="">
            </picture>
          </h3>
          <p class="hashtag">
            <span># 美容に興味がある方</span><br class="sp">
            <span># 患者様への細やかな栄養相談の対応が得意な方</span>
          </p>
          <p class="lead">
            管理栄養士のみなさんは美容クリニックで働くことを検討したことはありますか？<br>
            美容に興味がある方、患者様への細やかな栄養相談の対応が得意な方には<br class="pc">
            とくにおすすめできる仕事です。<br>
            基本的に夜勤や残業が少なく、福利厚生が整った求人が多いことも魅力♪<br>
            転職をお考えの方は、選択肢のひとつとしてぜひご検討ください。
          </p>
        </div>
      </section>
      ...
      <section class="point">
        <div class="content">
          ...
          <h3 class="heading">
            <picture>
              <source media="(min-width: 768px)" srcset="../../special/img/beauty/heading_img02.svg" sizes="450px">
              <source srcset="../../special/img/beauty/heading_img02_sp.svg 450w" sizes="100%">
              <img src="../../special/img/beauty/heading_img02_sp.svg" alt="">
            </picture>
            <!-- <img src="../../special/img/beauty/heading_img02.svg" alt="美容クリニックで働く魅力とは？"> -->
          </h3>
          ...
          <div class="card-unit card-unit-col03">
            <div class="card">
              <div class="card-head active">
                <span class="card-point">
                  <img src="../../special/img/beauty/card_heading01_sp.png" alt="sp">
                </span>
                <img src="../../special/img/beauty/card_heading01_pc.png" alt="" class="pc">
                <p class="card-ttl sp">
                  予防医療に携わる！<br>
                  治験コーディネーター
                </p>
              ...
              <div class="card-body active">
                ...
                <p class="card-txt">
                  美容クリニックとは美容医療専門の医療機関のことを指します。管理栄養士として美容クリニックで働く場合は、<span>患者様への栄養アドバイス</span>がメイン業務となることが多く、<span>コミュニケーション力</span>が重視されます。<br>
                  クリニックによって、医師や看護師目的が「美容」となりますので、通常の病院やクリニックとは違う経験が積めるところが魅力です！
                </p>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-head">
                <span class="card-point">
                  <img src="../../special/img/beauty/card_heading02_sp.png" alt="1">
                </span>
                <img src="../../special/img/beauty/card_heading02_pc.png" alt="" class="pc">
                <p class="card-ttl sp">
                  美容クリニックで<br>
                  働く魅力とは？
                </p>
              ...
              <div class="card-body">
                ...
                <p class="card-txt">
                  美容クリニックの管理栄養士求人でとくに魅力なのが<span>基本的に夜勤がなく、残業も少ない</span>という点です。通常の病院やクリニックの忙しさや仕事内容が合わなかったという方にもおすすめできます。<br>
                  また、女性割合が多い職場が多いため、<span>育休や産休の取得率が高く、福利厚生が整った安心して働ける</span>クリニックが多いところも特徴。
                </p>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-head">
                <span class="card-point">
                  <img src="../../special/img/beauty/card_heading03_sp.png" alt="1">
                </span>
                <img src="../../special/img/beauty/card_heading03_pc.png" alt="" class="pc">
                <p class="card-ttl sp">
                  美容クリニックで<br>
                  働く際に気をつけること
                </p>
      ...
      <div class="cta">
        <div class="content">
          ...
          <div class="btn-wrap">
            <p class="lead">
              <img src="../../special/img/beauty/text01.svg" alt="臨床検査技師"><br>
              管理栄養士の美容クリニック求人は<br>
              マイナビコメディカルの<br>
              専任アドバイザーへご相談ください！
            </p>
              ...
              <div class="swiper-wrapper">
                  ...
                  <div class="card02">
                    <div class="card02-head">
                      <div class="card02-img">
                        <img src="../../special/img/beauty/offer_img_nrd01.png" alt="">
                      </div>
                      <p class="card02-ttl">
                        年間休日120日！福利厚生充実！<br>
                        ワークライフバランス◎
                    ...
                    <div class="card02-body">
                      <div class="label-wrap">
                        ...
                        <span class="card02-job">管理栄養士</span>
                      </div>
                      ...
                      <p class="card02-txt">
                        栄養アドバイスや相談対応のお仕事です♪ やりがいがある人気求人◎
                      </p>
                    </div>
                    <div class="btn-wrap">
                ...
                <div class="swiper-slide">
                  <div class="card02">
                    <div class="card02-head">
                      <div class="card02-img">
                        <img src="../../special/img/beauty/offer_img_nrd02.png" alt="">
                      </div>
                      <p class="card02-ttl">
                        未経験OK！美容業界で<br>
                        働いてみたい方必見の求人です！
                    ...
                    <div class="card02-body">
                      ...
                      <p class="card02-txt">
                        栄養指導未経験での応募可能な求人です！最先端の技術を学べます◎
                      </p>
                    </div>
                    <div class="btn-wrap">
                      <a href="/entry/?recruitno=9114581&Linkid=job01_beauty_CV" class="btn-job-entry">
      ...
      <section class="merit bg-green">
        <div class="content">
          <h3 class="heading">
            <img src="../../special/img/beauty/heading_img04_pc.svg" alt="マイナビコメディカルの強み" class="sp">
            <img src="../../special/img/beauty/heading_img04_pc.svg" alt="マイナビコメディカルの強み" class="pc">
          </h3>

          <section id="merit01" class="l-section">
            <div class="l-section__inner">
              <div class="l-section__illust">
                <div class="l-section__illust-bg">
                  <img class="l-section__illust-interior" src="../../special/img/beauty/card03_img01.png">
                </div>
              </div>
              <div class="l-section__content">
                <h3 class="l-section-title js__tsc-title type-anime">
                  <span class="en opacity">A LOTS OF<br>JOBS</span>
          ...
          <section id="merit02" class="l-section">
            <div class="l-section__inner">
              <div class="l-section__illust">
                <div class="l-section__illust-bg">
                  <img class="l-section__illust-interior" src="../../special/img/beauty/card03_img02.png">
                </div>
              </div>
              <div class="l-section__content">
                <h3 class="l-section-title js__tsc-title type-anime">
                ...
                <p class="merit-txt">
                  ...
                  マイナビコメディカルは全国20ヶ所にオフィスを展開。実際に現地に足を運び、採用担当者だけではなく、施設長や現場のセラピストさんにもお話を伺っています。<br>
                  賞与の実績や残業の実際、有給取得率、産休復帰率などはもちろん、職場の雰囲気や社風など、インターネットで求人を見るだけでは知りえないポイントをお伝えします。</p>
              </div>
            </div>
          </section>

          <section id="merit03" class="l-section">
            <div class="l-section__inner">
              <div class="l-section__illust">
                <div class="l-section__illust-bg">
                  <img class="l-section__illust-interior" src="../../special/img/beauty/card03_img03.png">
                </div>
              </div>
              <div class="l-section__content">
                <h3 class="l-section-title js__tsc-title type-anime">
      ...
      <!-- マイナビコメディカルを利用された方の声 -->
      <section class="uservoice bg-green">
...
<script src="../../special/js/default.js" charset="UTF-8"></script>
