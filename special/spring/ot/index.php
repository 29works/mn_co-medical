...
<head>
  ...
  <title>【作業療法士】春入職の求人特集｜作業療法士（OT）の求人・転職ならマイナビコメディカル</title>
...
<body>
  ...
  <header class="header">
    <div class="header-inner">
      ...
      <div class="btn-wrap">
        <a class="btn-entry" href="/entry/?recruitno=9134996&Linkid=mv_springOT_CV">
        ...
        <div id="luxy">
          ...
          <div class="luxy-el mv__pic js-mv__pic" data-speed-y="0" data-offset="-50">
            <picture>
              ...
              <img data-range="8" src="/special/img/spring/mv__pic.png" alt="作業療法士の春入職特集">
            </picture>
          </div>
        </div>

        <h2 class="mv-ttl">
          <img src="/special/img/spring/mv-ttl-ot.svg" alt="作業療法士の春入職特集">
        </h2>

        <div class="luxy-el mv__people js-mv__people">
          <img data-range="1" src="/special/img/spring/mv__people.png" alt="作業療法士の男女">
        </div>
    ...
    <div class="contents">
      <section class="about">
        <div class="content">
          ...
          <p class="lead">
            春シーズン入職の求人は、作業療法士求人の中でも<br class="pc">
          ...
          <div class="card-unit card-unit-col03">
            ...
            <div class="card">
              ...
              <div class="card-body active">
                ...
                <p class="card-txt">
                  作業療法士の求人数は夏頃から増え始め、9月から翌年2月が一番多くなります。<span>年度の変わる4月に合わせて募集が増える</span>ためです。求人数が多い分、希望の職場を探しやすくなります。
                </p>
              </div>
            </div>
      ...
      <div class="cta paper">
        <div class="content">
          ...
          <div class="btn-wrap">
            ...
            <div class="pc">
              <a class="btn-entry btn-entry--blank" href="/entry/?recruitno=9134996&Linkid=cta_springOT_CV"
                target="_blank">
              ...
              <div class="swiper-wrapper">
                  ...
                  <div class="card02">
                    <div class="card02-head">
                      <div class="card02-img">
                        <img src="/special/img/spring/offer_img_ot01.jpg" alt="求人01">
                      </div>
                      <p class="card02-ttl">
                        資格取得奨励金で<br>
                        モチベもスキルもアップ◎
                    ...
                    <div class="card02-body">
                      <div class="label-wrap">
                        <span class="card02-job">作業療法士</span>
                    ...
                    <div class="btn-wrap">
                      <a href="/entry/?recruitno=9134996&Linkid=job01_springOT_CV" class="btn-job-entry">
                        紹介してもらう
                      </a>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="card02">
                    <div class="card02-head">
                      <div class="card02-img">
                        <img src="/special/img/spring/offer_img_ot02.png" alt="求人02">
                      </div>
                      <p class="card02-ttl">
                        年間休日129日！<br>
                        有給消化率90％以上の実績
                    ...
                    <div class="btn-wrap">
                      <a href="/entry/?recruitno=9134996&Linkid=job02_springOT_CV" class="btn-job-entry">
                        紹介してもらう
                      </a>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="card02">
                    <div class="card02-head">
                      <div class="card02-img">
                        <img src="/special/img/spring/offer_img_ot03.png" alt="求人03">
                      </div>
                      <p class="card02-ttl">
                        インセンティブあり！<br>
                        年収500万円以上も◎
                    ...
                    <div class="btn-wrap">
                      <a href="/entry/?recruitno=9134996&Linkid=job03_springOT_CV" class="btn-job-entry">
                        紹介してもらう
                      </a>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="card02">
                    <div class="card02-head">
                      <div class="card02-img">
                        <img src="/special/img/spring/offer_img_ot04.jpg" alt="求人04">
                      </div>
                      <p class="card02-ttl">
                        仕事とプライベートを<br>
                        両立しやすい◎車通勤OK
                    ...
                    <div class="btn-wrap">
                      <a href="/entry/?recruitno=9134996&Linkid=job04_springOT_CV" class="btn-job-entry">
                        紹介してもらう
                      </a>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="card02">
                    <div class="card02-head">
                      <div class="card02-img">
                        <img src="/special/img/spring/offer_img_ot05.png" alt="求人05">
                      </div>
                      <p class="card02-ttl">
                        月給30万円で別途賞与あり！<br>
                        年収重視の方に◎
                    ...
                    <div class="btn-wrap">
                      <a href="/entry/?recruitno=9134996&Linkid=job05_springOT_CV" class="btn-job-entry">
                        紹介してもらう
                      </a>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="card02">
                    <div class="card02-head">
                      <div class="card02-img">
                        <img src="/special/img/spring/offer_img_ot06.png" alt="求人06">
                      </div>
                      <p class="card02-ttl">
                        駅から徒歩3分で通勤便利◎<br>
                        年間休日120日以上！
                    ...
                    <div class="btn-wrap">
                      <a href="/entry/?recruitno=9134996&Linkid=job06_springOT_CV" class="btn-job-entry">
                        紹介してもらう
                      </a>
                    </div>
                  </div>
              ...
              <div class="m-section__inner animated-items">
                ...
                <div class="m-section__content">
                  ...
                  <p class="merit-txt">
                    ...
                    マイナビコメディカルは全国20ヶ所にオフィスを展開。実際に現地に足を運び、採用担当者だけではなく、施設長や現場の作業療法士さんにもお話を伺っています。<br>
  ...
  <div class="floating">
    <div class="btn-wrap">
      <a href="/entry/?recruitno=9134996&Linkid=footer_springOT_CV" class="btn-entry">
        <span>完全無料 | 求人を紹介してもらう</span>
      </a>
    </div>
  </div>
